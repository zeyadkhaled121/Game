...
public class ZombieGameListener extends ZombieAnimListener {
    ...
    boolean gameOverSoundPlayed = false; // لمنع تكرار صوت الموت
    ...
    String textureNames[] = {
            ...
            "BG.png",
            "ARM2.png","ARM1.png","ARM3.png","ARM4.png"
    };
    ...
    // ====================================================
    // الصوتيات والتحكم بالخطوات
    // ====================================================
    long lastStepTime = 0;
    final int STEP_INTERVAL = 200; // ms بين كل خطوة
    ...
    public void init(GLAutoDrawable gld) {
        // تشغيل المزيكا الخلفية loop مرة واحدة عند بداية اللعبة
        ...
        for(int i=0;i<textureNames.length;i++){
            try{
                ...
                new GLU().gluBuild2DMipmaps(GL.GL_TEXTURE_2D, GL.GL_RGBA, texture[i].getWidth(),
    ...
    private void handleLogic(){
        ...
        // صوت الخطوات WAV مستقل عن المزيكا الخلفية
        if(isSoldierMoving){
        ...
        if(isKeyPressed(KeyEvent.VK_SPACE)){
            ...
            if(currentTime - lastFireTime>200){
                ...
                UniversalSoundPlayer.play("src/soundeffects/mixkit-game-gun-shot-1662.mp3");
        ...
        for(Zombie z : zombies){
            ...
            if(distance<5.0){
                if(!gameOver){
                    gameOver=true;
                    // إيقاف المزيكا الخلفية loop وأي أصوات مؤقتة
                    UniversalSoundPlayer.stopLoop();
                    UniversalSoundPlayer.stop();
                    // صوت Game Over مرة واحدة
    ...
    @Override public void keyPressed(final KeyEvent event){ keyBits.set(event.getKeyCode()); }
