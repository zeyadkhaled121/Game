...
public class ZombieGameMenu extends JFrame implements GLEventListener, MouseListener {
    ...
    public ZombieGameMenu() {
        ...
        try {
            String iconPath = "src/Game Assets/logo.png";
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            menuBackgroundTexture = TextureIO.newTexture(new File("src/Game Assets/background.png"), true);
            levelSelectImage = TextureIO.newTexture(new File("src/Game Assets/levels.png"), true);
            gameBackgroundTexture = TextureIO.newTexture(new File("src/Game Assets/wlcome.png"), true);
            instructionsBackground = TextureIO.newTexture(new File("src/Game Assets/instr.png"), true);
        } catch (Exception e) {
